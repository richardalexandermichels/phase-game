package com.rmichels.phasegame.ui.design
...
import com.rmichels.phasegame.design.DESIGN_MAX_CHORD_SIZE
...
import com.rmichels.phasegame.music.PIANO_PITCH_CLASS_LABELS
...
internal fun DesignScreen(
    ...
    fun previewCurrentBar() {
        ...
        for (step in 0 until design.stepCount) {
            val targetNanos =
                startNanos +
                    step * activeBackingTrackStepDurationMs * 1_000_000L
            when (editor) {
                DesignEditor.BASE -> {
